...
## Project Structure
    ...
    ├── testapiautoconnecto_76934  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_76934`
...
2. Clone this repo and `cd testapiautoconnecto_76934`
